...
('svpl_001', 'database', 2),
('svpl_002', 'kecerdasan_artifisia', 2),
...
(2, 'sv_001', 'svpl_001', 90),
(3, 'sv_001', 'svpl_002', 87),
(4, 'sv_001', 'svpl_003', 88),
(5, 'sv_002', 'svpl_001', 98),
(6, 'sv_002', 'svpl_002', 77);
...
ALTER TABLE `perkuliahan`
  ...
  ADD KEY `perkuliahan_mahasiswa_trpl` (`nim`),
  ADD KEY `pekuliahan_mk_mahasiswa` (`kode_mk`);
...
--
ALTER TABLE `perkuliahan`
  MODIFY `id_perkuliahan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `perkuliahan`
  ADD CONSTRAINT `pekuliahan_mk_mahasiswa` FOREIGN KEY (`kode_mk`) REFERENCES `matakuliah` (`kode_mk`),
  ADD CONSTRAINT `perkuliahan_mahasiswa_trpl` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`);
COMMIT;
